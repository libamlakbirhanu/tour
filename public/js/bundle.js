...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../utils/catch-async-errors.js":[function(require,module,exports) {
...
var _catchAsyncErrors = _interopRequireDefault(require("../../utils/catch-async-errors"));
...
exports.login = login;
var logout = (0, _catchAsyncErrors.default)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  var res;
...
},{"axios":"../../node_modules/axios/index.js","../../utils/catch-async-errors":"../../utils/catch-async-errors.js","./alerts":"alerts.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhlb3V0Y2FzdCIsImEiOiJja2p3NGd5dW0wZXp4Mm9sNzJyaGZvbmdrIn0.Loi74Zb4snsV9ZBK5kLaaw';
...
if (logoutLink) logoutLink.addEventListener('click', _login.logout);
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.querySelector('#input__photo-upload').files[0]);
    (0, _updateSettings.updateSettings)(form, 'data');
  });
}

if (userDataSettings) {
  userDataSettings.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              confirmPassword = document.querySelector('#password-confirm.form__input').value;
              _context.next = 7;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2732" + '/');
